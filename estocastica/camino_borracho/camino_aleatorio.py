...
def simular_caminata(pasos,  numero_de_intentos, tipo_de_borracho):
    borracho = tipo_de_borracho(nombre="Manquito")
...
def main(distancia_de_caminatas, numero_de_intentos, tipo_de_borracho):
    distancia_media_por_caminata = []
    for pasos in distancia_de_caminatas:
    ...
    graficar(distancia_de_caminatas, distancia_media_por_caminata)


if __name__ == "__main__":
    distancia_de_caminatas = [10, 100, 1000, 10000]
    numero_de_intentos = 100
    main(distancia_de_caminatas, numero_de_intentos, BorrachoTradicional)
